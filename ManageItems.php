        ...
        <div id="tenant-list">
          <div class="tenanttenant" style="display: flex; flex-direction: row; column-gap: 2rem;">
            ...
            <div id="tenant-details">
              ...
              <div class="detail" id="category">Category: <?= $category?></div>
              <br><br>
              <button style="padding:.5rem; border: 1px solid orange; border-radius:2rem"><a href="addItems.php">Add Items</a></button>
            </div>
          </div>
        </div>
        <br>
